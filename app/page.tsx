...
export default function Home() {
    ...
    const thirdSectionRef = useRef<HTMLDivElement>(null) // Nuevo ref para la tercera sección
    const contentThirdSectionRef = useRef<HTMLDivElement>(null) // Nuevo ref para el contenido de la tercera sección
    ...
    useGSAP(
        () => {
            ...
            // *** Nueva animación para la tercera sección ***
            if (thirdSectionRef.current && contentThirdSectionRef.current) {
                ...
                thirdSectionTimeline.fromTo(
                    thirdSectionRef.current.querySelector('.third_section_h2'),
                    { opacity: 0, x: "50%" },
                    { opacity: 1, x: 0, duration: 1.5 }
                );

                // Animación para el content_third_section
                thirdSectionTimeline.fromTo(
                    contentThirdSectionRef.current,
                    { opacity: 0, y: "50%" },
                    { opacity: 1, y: "0%", duration: 1.5 },
                    "<" // Inicia al mismo tiempo que la animación anterior
                );

                // Crea el ScrollTrigger para la tercera sección
                ScrollTrigger.create({
                    trigger: thirdSectionRef.current,
                    start: "top 80%", // La animación comienza cuando la parte superior de la sección entra al 80% del viewport
                    end: "bottom bottom",
                    animation: thirdSectionTimeline,
                    toggleActions: "play none none none" // Reproduce la animación una sola vez
                });
            }
        },
        {
    ...
    return (
        ...
        <div id="smooth-wrapper" ref={smootherWrapper}>
            <div id="smooth-content" ref={smootherContent}>
                ...
                <section ref={thirdSectionRef} className="third_section">
                    <h2 className='third_section_h2'>Our <span>Values</span></h2>
                    <div ref={contentThirdSectionRef} className="content_third_section">
                    {isMobile ? 
